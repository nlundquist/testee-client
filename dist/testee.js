    ...
    (function (modules) {
        ...
        function (module, exports, __webpack_require__) {
            ...
            if (!(HAS_INSTANCE in FunctionProto))
                __webpack_require__(6).f(FunctionProto, HAS_INSTANCE, {
                    value: function (O) {
...
define('lodash/_customDefaultsAssignIn', [
    'require',
    'exports',
    'module',
    'lodash/eq'
...
define('lodash/defaults', [
    ...
    'lodash/assignInWith',
    'lodash/_baseRest',
    'lodash/_customDefaultsAssignIn'
], function (require, exports, module) {
...
/*feathers@2.2.2#lib/mixins/promise*/
...
/*feathers@2.2.2#lib/mixins/event*/
...
/*feathers@2.2.2#lib/mixins/normalizer*/
...
/*feathers@2.2.2#lib/mixins/index*/
...
/*feathers@2.2.2#lib/application*/
...
/*feathers@2.2.2#lib/client/express*/
...
/*feathers@2.2.2#lib/client/index*/
...
/*feathers-rest@1.8.0#lib/client/base*/
...
/*feathers-rest@1.8.0#lib/client/jquery*/
...
/*feathers-rest@1.8.0#lib/client/superagent*/
...
/*feathers-rest@1.8.0#lib/client/request*/
...
/*feathers-rest@1.8.0#lib/client/fetch*/
...
/*feathers-rest@1.8.0#lib/client/axios*/
...
/*feathers-rest@1.8.0#lib/client/angular*/
...
/*feathers-rest@1.8.0#lib/client/index*/
...
/*superagent@3.6.3#lib/is-object*/
...
/*superagent@3.6.3#lib/request-base*/
...
/*superagent@3.6.3#lib/response-base*/
...
/*superagent@3.6.3#lib/should-retry*/
define('superagent/lib/should-retry', function (require, exports, module) {
    var ERROR_CODES = [
        'ECONNRESET',
        'ETIMEDOUT',
        'EADDRINFO',
...
define('superagent/lib/client', [
    ...
    var shouldRetry = require('superagent/lib/should-retry');
    function noop() {
    }
    ;
...
/*testee-client@0.5.1#adapters/qunit*/
...
/*testee-client@0.5.1#adapters/jasmine-legacy*/
...
/*testee-client@0.5.1#adapters/jasmine*/
...
/*lodash@4.17.4#_setCacheAdd*/
define('lodash/_setCacheAdd', function (require, exports, module) {
    var HASH_UNDEFINED = '__lodash_hash_undefined__';
...
/*lodash@4.17.4#_setCacheHas*/
define('lodash/_setCacheHas', function (require, exports, module) {
    function setCacheHas(value) {
        return this.__data__.has(value);
    }
    module.exports = setCacheHas;
});
/*lodash@4.17.4#_SetCache*/
define('lodash/_SetCache', [
    'require',
    'exports',
    'module',
    'lodash/_MapCache',
    ...
    var MapCache = require('lodash/_MapCache'), setCacheAdd = require('lodash/_setCacheAdd'), setCacheHas = require('lodash/_setCacheHas');
...
/*lodash@4.17.4#_arraySome*/
define('lodash/_arraySome', function (require, exports, module) {
...
/*lodash@4.17.4#_cacheHas*/
define('lodash/_cacheHas', function (require, exports, module) {
    function cacheHas(cache, key) {
        return cache.has(key);
    }
    module.exports = cacheHas;
});
/*lodash@4.17.4#_equalArrays*/
define('lodash/_equalArrays', [
    'require',
    'exports',
    'module',
    'lodash/_SetCache',
    ...
    var SetCache = require('lodash/_SetCache'), arraySome = require('lodash/_arraySome'), cacheHas = require('lodash/_cacheHas');
...
/*lodash@4.17.4#_equalByTag*/
define('lodash/_equalByTag', [
    'require',
    'exports',
    'module',
    'lodash/_Symbol',
    ...
    var Symbol = require('lodash/_Symbol'), Uint8Array = require('lodash/_Uint8Array'), eq = require('lodash/eq'), equalArrays = require('lodash/_equalArrays'), mapToArray = require('lodash/_mapToArray'), setToArray = require('lodash/_setToArray');
    var COMPARE_PARTIAL_FLAG = 1, COMPARE_UNORDERED_FLAG = 2;
...
/*lodash@4.17.4#_baseIsEqualDeep*/
define('lodash/_baseIsEqualDeep', [
    'require',
    'exports',
    'module',
    'lodash/_Stack',
    ...
    var Stack = require('lodash/_Stack'), equalArrays = require('lodash/_equalArrays'), equalByTag = require('lodash/_equalByTag'), equalObjects = require('lodash/_equalObjects'), getTag = require('lodash/_getTag'), isArray = require('lodash/isArray'), isBuffer = require('lodash/isBuffer'), isTypedArray = require('lodash/isTypedArray');
    var COMPARE_PARTIAL_FLAG = 1;
...
/*lodash@4.17.4#_baseIsEqual*/
define('lodash/_baseIsEqual', [
    'require',
    'exports',
    'module',
    ...
    var baseIsEqualDeep = require('lodash/_baseIsEqualDeep'), isObjectLike = require('lodash/isObjectLike');
...
/*lodash@4.17.4#_baseIsMatch*/
define('lodash/_baseIsMatch', [
    'require',
    'exports',
    'module',
    'lodash/_Stack',
...
/*lodash@4.17.4#_isStrictComparable*/
define('lodash/_isStrictComparable', [
    'require',
    'exports',
    'module',
    'lodash/isObject'
...
/*lodash@4.17.4#_getMatchData*/
define('lodash/_getMatchData', [
    'require',
    'exports',
    'module',
    ...
    var isStrictComparable = require('lodash/_isStrictComparable'), keys = require('lodash/keys');
...
/*lodash@4.17.4#_matchesStrictComparable*/
define('lodash/_matchesStrictComparable', function (require, exports, module) {
...
/*lodash@4.17.4#_baseMatches*/
define('lodash/_baseMatches', [
    'require',
    'exports',
    'module',
    'lodash/_baseIsMatch',
    ...
    var baseIsMatch = require('lodash/_baseIsMatch'), getMatchData = require('lodash/_getMatchData'), matchesStrictComparable = require('lodash/_matchesStrictComparable');
...
/*lodash@4.17.4#_isKey*/
define('lodash/_isKey', [
    'require',
    'exports',
    'module',
    'lodash/isArray',
    ...
    var isArray = require('lodash/isArray'), isSymbol = require('lodash/isSymbol');
...
/*lodash@4.17.4#memoize*/
define('lodash/memoize', [
    'require',
    'exports',
    'module',
    'lodash/_MapCache'
...
/*lodash@4.17.4#_memoizeCapped*/
define('lodash/_memoizeCapped', [
    'require',
    'exports',
    'module',
    'lodash/memoize'
...
/*lodash@4.17.4#_stringToPath*/
define('lodash/_stringToPath', [
    'require',
    'exports',
    'module',
...
/*lodash@4.17.4#_baseToString*/
define('lodash/_baseToString', [
    'require',
    'exports',
    'module',
    'lodash/_Symbol',
    ...
    var Symbol = require('lodash/_Symbol'), arrayMap = require('lodash/_arrayMap'), isArray = require('lodash/isArray'), isSymbol = require('lodash/isSymbol');
    var INFINITY = 1 / 0;
...
/*lodash@4.17.4#toString*/
define('lodash/toString', [
    'require',
    'exports',
    'module',
...
/*lodash@4.17.4#_castPath*/
define('lodash/_castPath', [
    'require',
    'exports',
    'module',
    'lodash/isArray',
    ...
    var isArray = require('lodash/isArray'), isKey = require('lodash/_isKey'), stringToPath = require('lodash/_stringToPath'), toString = require('lodash/toString');
...
/*lodash@4.17.4#_toKey*/
define('lodash/_toKey', [
    'require',
    'exports',
    'module',
    'lodash/isSymbol'
...
/*lodash@4.17.4#_baseGet*/
define('lodash/_baseGet', [
    'require',
    'exports',
    'module',
    'lodash/_castPath',
    ...
    var castPath = require('lodash/_castPath'), toKey = require('lodash/_toKey');
...
/*lodash@4.17.4#_baseHasIn*/
define('lodash/_baseHasIn', function (require, exports, module) {
    function baseHasIn(object, key) {
        return object != null && key in Object(object);
    }
    module.exports = baseHasIn;
});
/*lodash@4.17.4#_hasPath*/
define('lodash/_hasPath', [
    'require',
    'exports',
    'module',
    'lodash/_castPath',
    ...
    var castPath = require('lodash/_castPath'), isArguments = require('lodash/isArguments'), isArray = require('lodash/isArray'), isIndex = require('lodash/_isIndex'), isLength = require('lodash/isLength'), toKey = require('lodash/_toKey');
...
define('lodash/hasIn', [
    ...
    var baseHasIn = require('lodash/_baseHasIn'), hasPath = require('lodash/_hasPath');
    function hasIn(object, path) {
        return object != null && hasPath(object, path, baseHasIn);
    }
    module.exports = hasIn;
});
/*lodash@4.17.4#_baseMatchesProperty*/
define('lodash/_baseMatchesProperty', [
    ...
    var baseIsEqual = require('lodash/_baseIsEqual'), get = require('lodash/get'), hasIn = require('lodash/hasIn'), isKey = require('lodash/_isKey'), isStrictComparable = require('lodash/_isStrictComparable'), matchesStrictComparable = require('lodash/_matchesStrictComparable'), toKey = require('lodash/_toKey');
    var COMPARE_PARTIAL_FLAG = 1, COMPARE_UNORDERED_FLAG = 2;
...
/*lodash@4.17.4#_baseProperty*/
define('lodash/_baseProperty', function (require, exports, module) {
...
/*lodash@4.17.4#_basePropertyDeep*/
define('lodash/_basePropertyDeep', [
    'require',
    'exports',
    'module',
    'lodash/_baseGet'
...
/*lodash@4.17.4#property*/
define('lodash/property', [
    'require',
    'exports',
    'module',
    ...
    var baseProperty = require('lodash/_baseProperty'), basePropertyDeep = require('lodash/_basePropertyDeep'), isKey = require('lodash/_isKey'), toKey = require('lodash/_toKey');
    function property(path) {
        return isKey(path) ? baseProperty(toKey(path)) : basePropertyDeep(path);
    }
    module.exports = property;
});
/*lodash@4.17.4#_baseIteratee*/
define('lodash/_baseIteratee', [
    'require',
    'exports',
    'module',
    'lodash/_baseMatches',
    ...
    var baseMatches = require('lodash/_baseMatches'), baseMatchesProperty = require('lodash/_baseMatchesProperty'), identity = require('lodash/identity'), isArray = require('lodash/isArray'), property = require('lodash/property');
...
/*lodash@4.17.4#_createFind*/
define('lodash/_createFind', [
    'require',
    'exports',
    'module',
    ...
    var baseIteratee = require('lodash/_baseIteratee'), isArrayLike = require('lodash/isArrayLike'), keys = require('lodash/keys');
...
/*lodash@4.17.4#findIndex*/
define('lodash/findIndex', [
    'require',
    'exports',
    'module',
    'lodash/_baseFindIndex',
    ...
    var baseFindIndex = require('lodash/_baseFindIndex'), baseIteratee = require('lodash/_baseIteratee'), toInteger = require('lodash/toInteger');
    var nativeMax = Math.max;
...
define('lodash/find', [
    ...
    var createFind = require('lodash/_createFind'), findIndex = require('lodash/findIndex');
...
/*testee-client@0.5.1#adapters/mocha*/
define('testee-client/adapters/mocha', [
    ...
    function TesteeReporter(runner) {
        ...
        runner.on('hook', function (hook) {
            var hookAlreadyExists = _.find(self.ids, function (phase) {
                return phase.fn === hook.fn;
            });
